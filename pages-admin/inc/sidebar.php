      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="menu.php?page=view_kelas" class="nav-link ">
                  <i class="fa fa-caret-right"></i>
                  <p>Kelas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="menu.php?page=view_mapel" class="nav-link">
                  <i class="fa fa-caret-right"></i>
                  <p>Mata Pelajaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="menu.php?page=view_guru" class="nav-link">
                  <i class="fa fa-caret-right"></i>
                  <p>Guru</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="menu.php?page=view_siswa" class="nav-link">
                  <i class="fa fa-caret-right"></i>
                  <p>Siswa</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="menu.php?page=view_jadwal" class="nav-link">
                  <i class="fa fa-caret-right"></i>
                  <p>Jadwal Mengajar</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="menu.php?page=view_manajemenuser" class="nav-link">
